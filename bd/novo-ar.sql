...
--
-- Máquina: localhost
-- Data de Criação: 18-Ago-2017 às 08:31
...
CREATE TABLE IF NOT EXISTS `cc_autor_noticia` (
  `aut_noticia_id` int(11) NOT NULL,
  `aut_usuario_id` int(11) NOT NULL,
  `aut_original` int(11) NOT NULL,
  PRIMARY KEY (`aut_noticia_id`,`aut_usuario_id`),
  KEY `fk_cc_noticia_has_cc_usuario_cc_usuario1_idx` (`aut_usuario_id`),
  KEY `fk_cc_noticia_has_cc_usuario_cc_noticia1_idx` (`aut_noticia_id`)
...
CREATE TABLE IF NOT EXISTS `cc_documento` (
  ...
  PRIMARY KEY (`doc_id`),
  KEY `fk_cc_documentos_grupo_usuario1_idx` (`doc_grupo_usuario_grupo_id`,`doc_grupo_usuario_usuario_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Tabela de Arquivos para Download' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `cc_download` (
  ...
  PRIMARY KEY (`dow_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='Tabela de Arquivos para Download';
...
CREATE TABLE IF NOT EXISTS `cc_empresa_instituicao` (
  ...
  PRIMARY KEY (`emp_id`),
  KEY `fk_cc_empresa_instituicao_cc_cidade1_idx` (`emp_cidade`)
...
CREATE TABLE IF NOT EXISTS `cc_estado` (
  ...
  PRIMARY KEY (`est_id`),
  KEY `fk_cc_estado_cc_pais1_idx` (`est_pais_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=COMPACT AUTO_INCREMENT=2 ;
...
CREATE TABLE IF NOT EXISTS `cc_evento` (
  ...
  PRIMARY KEY (`eve_id`),
  KEY `fk_cc_eventos_tipo_evento1_idx` (`eve_tipo_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Tabela de Eventos' AUTO_INCREMENT=3 ;
...
CREATE TABLE IF NOT EXISTS `cc_evento_nucleo` (
  ...
  PRIMARY KEY (`evl_evento_id`,`evl_nucleo_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `cc_fomento` (
...
CREATE TABLE IF NOT EXISTS `cc_grupo` (
...
CREATE TABLE IF NOT EXISTS `cc_grupo_usuario` (
  `gro_grupo_id` int(11) NOT NULL,
  `gro_usuario_id` int(11) NOT NULL,
  PRIMARY KEY (`gro_grupo_id`,`gro_usuario_id`),
  KEY `fk_grupo_has_usuario_usuario1_idx` (`gro_usuario_id`),
  KEY `fk_grupo_has_usuario_grupo_idx` (`gro_grupo_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `cc_grupo_usuario_subarea_conhecimento` (
  ...
  PRIMARY KEY (`grt_subarea_conhecimento_id`),
  KEY `fk_professores_has_subarea_conhecimento_subarea_conheciment_idx` (`grt_subarea_conhecimento_id`),
  KEY `fk_professores_subarea_conhecimento_grupo_usuario1_idx` (`grt_grupo_usuario_grupo_id`,`grt_grupo_usuario_usuario_id`)
...
CREATE TABLE IF NOT EXISTS `cc_intercambista` (
  ...
  PRIMARY KEY (`int_usuario_id`),
  KEY `fk_intercambista_fomento1_idx` (`int_fomento_id`),
  KEY `fk_intercambista_grupo_usuario1_idx` (`int_grupo_usuario_grupo_prof_id`,`int_grupo_usuario_usuario_prof_id`),
  KEY `fk_intercambista_grupo_usuario2_idx` (`int_grupo_usuario_grupo_usu_id`,`int_grupo_usuario_usuario_usu_id`),
  KEY `fk_intercambista_cidade1_idx` (`int_cidade_id`,`int_cidade_est`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `cc_linha_pesquisa` (
...
CREATE TABLE IF NOT EXISTS `cc_link` (
  `lik_id` int(100) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`lik_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='Tabela de Links' AUTO_INCREMENT=1 ;
...
(105, 'O usuário aluno do curso adicionou uma nova notícia!', '2017-08-14 11:21:16', 'add-noticia', 10, 'O usuario do sistema: <b>aluno do curso</b>, adicionou uma nova notícia com titulo: <b>asdasd</b>, as <b>11:21:16 14/08/2017</b>'),
(106, 'O usuário aluno do curso removeu uma notícia!', '2017-08-14 11:21:32', 'rmv-noticia', 10, 'O usuario do sistema: <b>aluno do curso</b>, removeu uma notícia com titulo: <b>asdasd</b>, e id <b>78</b>, as <b>11:21:32 14/08/2017</b>'),
(107, 'O usuário Perses De Vilhena removeu a duplicação de uma notícia!', '2017-08-14 20:58:55', 'rmv-duplicacao-noticia', 3, 'O usuario do sistema: <b>Perses De Vilhena</b>, removeu a duplicação da notícia com titulo: <b>Projeto RONDON 2010</b>, e id <b>1</b>, as <b>20:58:55 14/08/2017</b>'),
(108, 'O usuário Perses De Vilhena duplicou uma notícia!', '2017-08-14 20:59:01', 'add-duplicacao-noticia', 3, 'O usuario do sistema: <b>Perses De Vilhena</b>, duplicou uma notícia com titulo: <b>Projeto RONDON 2010</b>, e id <b>1</b>, as <b>20:59:01 14/08/2017</b>'),
(109, 'O usuário Perses De Vilhena aprovou uma notícia!', '2017-08-16 10:03:40', 'add-aprovacao-noticia', 3, 'O usuario do sistema: <b>Perses De Vilhena</b>, aprovou uma notícia com titulo: <b>Projeto RONDON 2010</b>, e id <b>1</b>, as <b>10:03:40 16/08/2017</b>');
...
CREATE TABLE IF NOT EXISTS `cc_noticia` (
  ...
  PRIMARY KEY (`not_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='Tabela de Notícias' AUTO_INCREMENT=79 ;
...
CREATE TABLE IF NOT EXISTS `cc_noticia_nucleo` (
  ...
  PRIMARY KEY (`noo_noticia_id`,`noo_nucleo_id`),
  KEY `fk_cc_noticias_has_nucleos_usuario_cc_noticias1_idx` (`noo_noticia_id`),
  KEY `fk_cc_noticia_nucleo_usuario_cc_nucleo1_idx` (`noo_nucleo_id`)
...
CREATE TABLE IF NOT EXISTS `cc_nucleo` (
  `nuc_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `cc_nucleo_linha_pesquisa` (
  `nus_nucleo_id` int(11) NOT NULL,
  `nus_linha_pesquisa_id` int(11) NOT NULL,
  PRIMARY KEY (`nus_nucleo_id`,`nus_linha_pesquisa_id`),
  KEY `fk_nucleos_has_areas_conhecimento_areas_conhecimento1_idx` (`nus_linha_pesquisa_id`),
  KEY `fk_nucleos_has_areas_conhecimento_nucleos1_idx` (`nus_nucleo_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `cc_nucleo_usuario` (
  ...
  PRIMARY KEY (`nuo_nucleo_id`,`nuo_usuario_id`),
  KEY `fk_nucleos_has_usuario_usuario1_idx` (`nuo_usuario_id`),
  KEY `fk_nucleos_has_usuario_nucleos1_idx` (`nuo_nucleo_id`),
  KEY `fk_nucleos_usuario_papel1_idx` (`nuo_papel_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `cc_nucleo_usuario_permissao` (
  `nua_nucleo` int(11) NOT NULL,
  `nua_usuario` int(11) NOT NULL,
  `nua_permissao` int(11) NOT NULL,
  `nua_sistema` int(11) NOT NULL,
  PRIMARY KEY (`nua_nucleo`,`nua_usuario`,`nua_permissao`,`nua_sistema`),
  KEY `fk_nucleos_usuario_has_permissoes_permissoes1_idx` (`nua_permissao`),
  KEY `fk_nucleos_usuario_has_permissoes_nucleos_usuario1_idx` (`nua_nucleo`,`nua_usuario`),
  KEY `nua_sistema_id` (`nua_sistema`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `cc_oportunidade` (
  `opo_id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`opo_id`),
  KEY `fk_cc_oportunidades_cc_empresa_instituicao1_idx` (`opo_empresa_instituicao`)
...
CREATE TABLE IF NOT EXISTS `cc_pais` (
...
CREATE TABLE IF NOT EXISTS `cc_papel` (
...
CREATE TABLE IF NOT EXISTS `cc_papel_projeto` (
...
CREATE TABLE IF NOT EXISTS `cc_permissao` (
...
CREATE TABLE IF NOT EXISTS `cc_projeto` (
  ...
  PRIMARY KEY (`pro_id`),
  KEY `fk_projetos_tipo_projeto1_idx` (`pro_tipo_projeto_id`),
  KEY `fk_projetos_fomento1_idx` (`pro_fomento_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `cc_publicacao` (
  ...
  PRIMARY KEY (`pub_id`),
  KEY `fk_publicacao_tipo_publicacao1_idx` (`pub_tipo_publicacao_id`),
  KEY `fk_publicacao_projetos1_idx` (`pub_projeto_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `cc_publicacao_usuario` (
  `puo_publicacao_id` int(11) NOT NULL,
  `puo_usuario_id` int(11) NOT NULL,
  `puo_ordem` int(11) NOT NULL,
  PRIMARY KEY (`puo_publicacao_id`,`puo_usuario_id`),
  KEY `fk_publicacao_has_usuario_usuario1_idx` (`puo_usuario_id`),
  KEY `fk_publicacao_has_usuario_publicacao1_idx` (`puo_publicacao_id`)
...
CREATE TABLE IF NOT EXISTS `cc_session` (
  ...
  PRIMARY KEY (`ses_id`),
  KEY `last_activity_idx` (`ses_last_activity`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `cc_sistema` (
...
CREATE TABLE IF NOT EXISTS `cc_subarea_conhecimento` (
...
CREATE TABLE IF NOT EXISTS `cc_subarea_conhecimento_nucleo` (
  `suo_subarea_conhecimento_id` int(11) NOT NULL,
  `suo_nucleo_id` int(11) NOT NULL,
  PRIMARY KEY (`suo_subarea_conhecimento_id`,`suo_nucleo_id`),
  KEY `fk_subarea_conhecimento_has_nucleos_nucleos1_idx` (`suo_nucleo_id`),
  KEY `fk_subarea_conhecimento_has_nucleos_subarea_conhecimento1_idx` (`suo_subarea_conhecimento_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `cc_tipo_evento` (
...
CREATE TABLE IF NOT EXISTS `cc_tipo_projeto` (
...
CREATE TABLE IF NOT EXISTS `cc_tipo_publicacao` (
...
CREATE TABLE IF NOT EXISTS `cc_usuario` (
  ...
  PRIMARY KEY (`usu_id`),
  KEY `fk_cc_pessoa_cc_cidade1_idx` (`usu_cidade`)
...
(3, 'Perses De Vilhena', 'perses', 'teste', NULL, NULL, 1, 'persesvilhena01@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, '2013-01-01', NULL, 1, 1, NULL, NULL),
(15, 'aluno1', 'aluno1', 'senha', NULL, NULL, NULL, 'aluno1', NULL, NULL, NULL, NULL, NULL, 'aluno1', NULL, NULL, 0, 1, NULL, NULL),
(16, 'aluno2', 'aluno2', 'senha', NULL, NULL, NULL, 'aluno2', NULL, NULL, NULL, NULL, NULL, 'aluno2', NULL, NULL, 0, 1, NULL, NULL),
(17, 'aluno3', 'aluno3', 'senha', NULL, NULL, NULL, 'aluno3', NULL, NULL, NULL, NULL, NULL, 'aluno3', NULL, NULL, 0, 1, NULL, NULL),
(20, 'estagiario1', 'estagiario1', 'senha', NULL, NULL, NULL, 'estagiario1', NULL, NULL, NULL, NULL, NULL, 'estagiario1', NULL, NULL, 0, 1, NULL, NULL),
(21, 'estagiario2', 'estagiario2', 'senha', NULL, NULL, NULL, 'estagiario2', NULL, NULL, NULL, NULL, NULL, 'estagiario2', NULL, NULL, 0, 1, NULL, NULL),
(22, 'estagiario3', 'estagiario3', 'senha', NULL, NULL, NULL, 'estagiario3', NULL, NULL, NULL, NULL, NULL, 'estagiario3', NULL, NULL, 0, 1, NULL, NULL),
(23, 'professor1', 'professor1', 'senha', NULL, NULL, NULL, 'professor1', NULL, NULL, NULL, NULL, NULL, 'professor1', NULL, NULL, 0, 1, NULL, NULL),
(24, 'professor2', 'professor2', 'senha', NULL, NULL, NULL, 'professor2', NULL, NULL, NULL, NULL, NULL, 'professor2', NULL, NULL, 0, 1, NULL, NULL),
(25, 'professor3', 'professor3', 'senha', NULL, NULL, NULL, 'professor3', NULL, NULL, NULL, NULL, NULL, 'professor3', NULL, NULL, 0, 1, NULL, NULL),
(26, 'coordenador1', 'coordenador1', 'senha', NULL, NULL, NULL, 'coordenador1', NULL, NULL, NULL, NULL, NULL, 'coordenador1', NULL, NULL, 0, 1, NULL, NULL),
(27, 'coordenador2', 'coordenador2', 'senha', NULL, NULL, NULL, 'coordenador2', NULL, NULL, NULL, NULL, NULL, 'coordenador2', NULL, NULL, 0, 1, NULL, NULL),
(28, 'coordenador3', 'coordenador3', 'senha', NULL, NULL, NULL, 'coordenador3', NULL, NULL, NULL, NULL, NULL, 'coordenador3', NULL, NULL, 0, 1, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `cc_usuario_projeto` (
  `uso_usuario_id` int(11) NOT NULL,
  `uso_projeto_id` int(11) NOT NULL,
  `uso_papel_projeto_id` int(11) NOT NULL,
  PRIMARY KEY (`uso_usuario_id`,`uso_projeto_id`),
  KEY `fk_usuario_has_projetos_projetos1_idx` (`uso_projeto_id`),
  KEY `fk_usuario_has_projetos_usuario1_idx` (`uso_usuario_id`),
  KEY `fk_usuario_projetos_papel_projeto1_idx` (`uso_papel_projeto_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
