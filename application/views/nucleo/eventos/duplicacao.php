<div id="page-wrapper">
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="" method="post">
                                        ...
                                        <input type="submit" name="rmv" value="Remover" class="btn btn-danger">
                                        <br>
                                </form>
                            </td>
                        </tr>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Duplicar evento <small><?= $evento->eve_titulo; ?></small></h1>
            <br>
            <form action="" method="post">
                ...
                <div style="float: right;">
                    <input type="submit" name="add" value="Duplicar" class="btn btn-success">
                </div>
            </form>
