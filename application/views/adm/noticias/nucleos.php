<div id="page-wrapper">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    <?php foreach ($todos_nucleos_duplicacao as $n){
                        if($n->noo_original == 1){ $tipo = "success"; $msg = "SIM"; }else{ $tipo = "danger"; $msg = "NÃO"; } 
                        ?>
                        <tr>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Adicionar nucleo <small><?= $noticia->not_titulo; ?></small></h1>
            <br>
            <form action="" method="post">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Adicionar nucleo original <small><?= $noticia->not_titulo; ?></small></h1>
            <br>
            <form action="" method="post">
                <div class="form-group">
                    <label>Escolha o nucleo: </label>
                ...
                <div style="float: right;">
                    <input type="submit" name="duplicar_noticia_original" value="Duplicar" class="btn btn-success">
                </div>
            </form>
